...
Modern, hızlı ve akıcı arayüzler geliştirerek yazdığım API'ları uçtan uca tamamlıyorum. Ayrıca projelerimde SignalR ile anlık etkileşimler kurmaya çalışıyor ve JWT ile temel güvenlik yapılarını kurgulayarak kendimi bu alanlarda geliştiriyorum.
